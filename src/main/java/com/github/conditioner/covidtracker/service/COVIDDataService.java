package com.github.conditioner.covidtracker.service;
...
public class COVIDDataService {
    ...
    @Getter
    private List<LocationModel> parentLocations = new ArrayList<>();
    ...
    public void fetchVirusData() throws IOException, InterruptedException {
        ...
        records.forEach(record -> {
            ...
            location.setDiffFromPreviousDay(latestCases - previousDayCases);
